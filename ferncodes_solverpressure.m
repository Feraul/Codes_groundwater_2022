...
function [p,flowrate,flowresult,flowratedif,dt_aux] = ferncodes_solverpressure( viscosity,...
...
if numcase==331 || numcase==431 || numcase==432 || numcase==433 || numcase==434
    ...
    %----------------------------------------------------------------------
    if strcmp(acel,'FPI')
        [p,flowrate,flowresult,flowratedif,dt_aux]=ferncodes_iterpicard(M_old,I_old,...
