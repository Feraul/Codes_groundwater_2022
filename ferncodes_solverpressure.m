...
function [p,flowrate,flowresult,flowratedif,dt_aux,kmap_h,faceaux] = ...
...
if numcase==331 || numcase==431 || numcase==432 || numcase==433 ...
    ...
    %----------------------------------------------------------------------
    if strcmp(acel,'FPI')
        [p,flowrate,flowresult,flowratedif,dt_aux,faceaux]=...
