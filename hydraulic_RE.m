...
while stopcriteria < 100
    ...
    elseif strcmp(pmethod,'mpfad')
        ...
        [h_new,flowrate,flowresult,flowratedif,dt_opcional] = ferncodes_solverpressure(...
            mobility,wells,Hesq,Kde,Kn,Kt,Ded,nflag,nflagface,...
            weight,s,Con,Kdec,Knc,Ktc,Dedc,nflagc,wightc,sc,SS,dt,h,MM,...
            gravrate,P,kmap,time,N,p_old,source,theta_s,theta_r,alpha,...
            pp,q,iterinicial,gravresult,flowresultZ);
        dt=dt_opcional;
