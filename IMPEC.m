    ...
    if numcase==246 || numcase==245 || numcase==247 || numcase==248 ||...
        ...
        if strcmp(pmethod,'nlfvpp')
            [pressure,flowrateadvec,flowresult,flowratedif]=...
                ...
                parameter,kmap,wells,viscosity,V,Con,N,p_old,contnorm,...
                weight,s,Con,nflagc,wightc,sc,dparameter);
        elseif strcmp(pmethod,'nlfvh')
             [pressure,flowrateadvec,flowresult,flowratedif]=...
                 ferncodes_solverpressureNLFVH(nflagface,...
            parameter,wells,mobility,weightDMP,p_old,0,0,0,...
            contnorm,weightDMPc,Con,nflagfacec,dparameter);
        
        elseif strcmp(pmethod,'mpfad')
            [pressure,flowrateadvec,flowresult,flowratedif] = ...
                ferncodes_solverpressure(viscosity,wells,Hesq,Kde,Kn,Kt,...
                Ded,nflag,weight,s,Con,Kdec,Knc,Ktc,Dedc,nflagc,wightc,sc);
