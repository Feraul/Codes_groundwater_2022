...
function setmethod(kmap,wells,keywrite,invh,limiterflag,klb,elemsize,...
    ...
    h_init,MM,dt,P,theta_s,theta_r,alpha,pp,q,h_old)
...
if phasekey ~= 0
    ...
    [transmvecleft,transmvecright,knownvecleft,knownvecright,storeinv,...
        ...
        gravrate,source,gravresult,flowrateZ,flowresultZ] = preMPFA(kmap,klb,...
        dmap,MM,h_init,wells,theta_s,theta_r,alpha,pp,q);
...
switch phasekey
    ...
    case 1 
        ...
        elseif strcmp(pmethod,'mpfad')
            ...
            [pressure,flowrate,] = ferncodes_solverpressure(1,...
                ...
                Knc,Ktc,Dedc,nflagnoc,weightc,sc,SS,dt,h_init,MM,gravrate,P);
        ...
        elseif strcmp(pmethod,'mpfah')
            [pressure,flowrate,]=ferncodes_solverpressureMPFAH(nflagface,...
                parameter,weightDMP,wells,SS,dt,h_init,MM,gravrate,P);
    ...
    case 2 %Two-Phase flow case:
        ...
        IMPES(Sw,injecelem,producelem,satinbound,wells,klb,satonvertices,...
            ...
            Con,nflagnoc,weightc,sc,dparameter,SS,dt,h_init,MM,gravrate,...
        ...
        if numcase==336 || numcase==334 ||numcase==335 || numcase==337 ...
            ...
            if strcmp(pmethod,'tpfa')
                ...
                [pressure,flowrate,] = ferncodes_solvePressure_TPFA(Kde, Kn,...
                    nflagface, Hesq,0,0,0,0,0,0,SS,dt,h_init,MM,P,time,source);
                %MPFA-D (Gao and Wu, 2010)
            elseif strcmp(pmethod,'mpfad')
                %Get "pressure" and "flowrate"
                [pressure,flowrate,] = ferncodes_solverpressure(1,...
                    ...
                    h_init,MM,gravrate,P,kmap,time,source);
            ...
            elseif strcmp(pmethod,'mpfah')
                [pressure,flowrate,]=ferncodes_solverpressureMPFAH(nflagface,...
                    parameter,weightDMP,wells,SS,dt,h_init,MM,gravrate,1,P,time,source);
            elseif strcmp(pmethod,'nlfvpp')
                [pressure,flowrate,]=ferncodes_solverpressureNLFVPP(nflagno,...
    ...
    case 6
           % steady-state problem
            ...
            hydraulic_RE(wells,overedgecoord,V,N,Hesq,Kde,Kn,Kt,Ded,kmap,nflag,...
                ...
                weightDMP,P,h_old,source,theta_s,theta_r,alpha,pp,q,...
